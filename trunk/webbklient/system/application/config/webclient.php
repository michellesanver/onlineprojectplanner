...
$config['webclient']['confirm_reset_url'] = "user_controller/resetpassword"; // parameters added in library Emailsender
...
$config['webclient']['activation_url'] = "user_controller/activate"; // parameters added in library Emailsender
