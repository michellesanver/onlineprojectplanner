...
$config['webclient']['activation_template'] = "Dear %s\nThis email is autogenerated because you have tried to register at %s.\nClick on the link below to activate:\n%s";
...
$config['webclient']['recommendation_template'] = "Hello, \nYour friend %s would like you to join this awesome applikation \"Superwiki\".\n You can find more information here, %s";

/* ---------------------------------------
* Settings for invitation mail
* --------------------------------------- */
$config['webclient']['invitation_template_subject'] = "Invitation email";
$config['webclient']['invitation_template'] = "This email is autogenerated because a friend of yours have invited you to become a member of his or her project over at the awesome application superwiki! %s \n

To accept the invitation, log in at your \"Superwiki\"-account and register your invitation code under project->accept invitation.\n\nInvitation code: %s";
