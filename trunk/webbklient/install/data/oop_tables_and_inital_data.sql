...
-- 
 CREATE TABLE `Widgets` (
    ...
    `Widget_name` VARCHAR( 50 ) NOT NULL  COMMENT 'synchronized with settings.xml',
    `Minimum_role` VARCHAR(25) NULL COMMENT 'synchronized with settings.xml',
    `In_development` TINYINT( 1 ) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'synchronized with settings.xml',
    `Is_core` TINYINT( 1 ) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'synchronized with settings.xml',
    `Have_DB` TINYINT( 1 ) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'synchronized with settings.xml',
    `DB_installed` TINYINT( 1 ) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'set run-time if installed',
