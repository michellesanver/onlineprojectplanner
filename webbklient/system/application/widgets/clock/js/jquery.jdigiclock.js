...
(function($) {
        ...
        jdigiclock: function(options) {
            ...
            return this.each(function() {
               ...
               // html    += '<p id="right_arrow"><img src="images/icon_right.png" /></p>';
                ...
                var panel_pos = ($('#plugin_container > div').length - 1) * 50;
                var next = function() {
                    $('#right_arrow').unbind('click', next);
                    $('#plugin_container > div').filter(function(i) {
                        $(this).animate({'left': (i * 50) - 50 + 'px'}, 30, function() {
                            if (i == 0) {
                ...
                var prev = function() {
                    ...
                    $('#plugin_container > div:last').prependTo('#plugin_container').css({'left':'-30px'});
                    $('#plugin_container > div').filter(function(i) {
                        $(this).animate({'left': i * 50 + 'px'}, 30, function() {
    ...
    $.fn.getWeather = function(el) {
        ...
        switch (el.proxyType) {
            case 'php':
                proxy = BASE_URL+ 'system/application/widgets/clock/lib/php/proxy.php';
            break;
            case 'asp':
                proxy = BASE_URL+ 'system/application/widgets/clock/lib/asp/WeatherProxy.aspx';
            break;
        }
