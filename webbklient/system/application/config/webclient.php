...
$config['webclient']['invitation_url'] = "account/accept"; // parameters added in library Emailsender
$config['webclient']['invitation_template'] = "This email is autogenerated because a friend og your have invited you to become a member of his project over at this awesome applikation \"Superwiki\" %s.<br /><br />Click on the link below to accept the invitation:<br /><a href=\"%s\">%s</a>";
